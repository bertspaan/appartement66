<script lang="ts">
 ...
 function update(){api?.update({floor,light,furniture,doorOpen,instrument,tipAge});}
 $: if(ready && api) api.update({floor,light,furniture,doorOpen,instrument,tipAge});
